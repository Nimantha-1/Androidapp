...
import com.example.dashboard.data.MyDatabase;
import com.example.dashboard.service.StepListener;

import java.text.SimpleDateFormat;
import java.util.Date;
import java.util.TimeZone;

public class MainActivitywk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainwk);
